...
#define SLURM_SIM_SHM "/alucero_slurm_sim.shm"

#define SIM_GLOBAL_SEM "alucero_slurm_simulator"
#define SIM_LOCAL_SEM_PREFIX "alucero_slurm_simulator_thread_sem_"
#define SIM_LOCAL_SEM_BACK_PREFIX "alucero_slurm_simulator_thread_sem_back_"
