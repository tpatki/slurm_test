...
static void *time_mgr(void *arg){
    ...
    while(1){ 
		...
		/*PATKI: EXACTLY BUDDY! THIS IS CAUSING SLURMD TO FAIL ON MERLOT AS NETSTAT TELLS ME THAT TCP IS LISTENING ON 6818*/
		/*PATKI: CHANGING THIS TO 6820 from 6818*/
		/*PATKI: AND NOW, BECAUSE OF THIS STUPID ISSUE, I NEED TO MAKE AGAIN.....AAAARGHHHHHH*/
                slurm_set_addr(&remote_addr, 6820, "localhost");
