...
if test "$PHP_SLURM" != "no"; then
	SLURMLIB_PATH="/home/tpatki/local/src/slurm-test/sim_test_dir/slurm_programs/lib ../../../src/db_api/.libs"
	SLURMINCLUDE_PATH="/home/tpatki/local/src/slurm-test/sim_test_dir/slurm_programs/include"
	...
	PHP_NEW_EXTENSION(slurm_php, ../../../contribs/phpext/slurm_php/slurm_php.c, $ext_shared)
fi
